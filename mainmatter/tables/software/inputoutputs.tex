\begin{table}[!ht]
	...
	\CAPTIONadd{This table lists the inputs and outputs of each software in a generic overall sense. In this specific project's case, the game engine is \gls{me}, the traffic software is \gls{vtd}, and the traffic software format is \gls{rdb}.}
\end{table}
