...
\section{\FONTsmallcaps{vtd} Implementation}\label{sc:middleware:implementation}
...
\begin{itemize}
	...
	\item \code{handle_TX_payload()} converts the data from \code{TrafficEntity} to the the \gls{rdb} format.
\end{itemize}
