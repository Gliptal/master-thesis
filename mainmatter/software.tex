...
\begin{image}
	...
	{}
	{The structure in this diagram is a high-level description of the role of each element, and how these elements are connected to each other. The game engine and the middleware reside on the same host \gls{os}, since the data connections is in-memory; the traffic software and the middleware may instead reside on different host \glspl{os}, since communication is done over the network.}
\end{image}
